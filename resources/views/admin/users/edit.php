            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="card">
                        ...
                        <form action="/admin/users/<?= $user['id'] ?>/update" method="POST" id="userForm">  
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label class="col-form-label">Name <span class="danger">*</span></label>
                                            <input name="name" id="name" type="text" class="form-control" placeholder="User Name" value="<?= $user['name'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="role_id" id="role_id">
                                                <?php foreach ($roles as $role) {
                                                    $id = $role['id'];
                                                    $name = $role['name'];
                                                    $selected = ($user['name'] == $role['id']) ? 'selected' : '';
